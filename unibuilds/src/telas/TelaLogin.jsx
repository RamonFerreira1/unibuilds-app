    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: cores.fundoPrincipal }}>
      ...
      >
        ...
        <View style={estilos.formulario}>
          ...
          <TouchableOpacity 
            style={estilos.botaoNavegarCadastro} 
            onPress={() => navegacao.navigate('Cadastro')}
          >
            <Text style={estilos.textoNavegarCadastro}>Não tem uma conta? Crie uma agora</Text>
          </TouchableOpacity>
        </View>
...
const estilos = StyleSheet.create({
  ...
  botaoNavegarCadastro: {
    alignItems: 'center',
    marginTop: 20,
    paddingVertical: 5,
  },
  textoNavegarCadastro: {
    color: cores.primaria,
    fontSize: 14,
    fontWeight: '600',
