...
export const dadosItens = [
  {
    ...
    imagem: 'https://via.placeholder.com/80/06101E/C8AA6E?text=Gume'
  },
  {
    id: '2',
    ...
    imagem: 'https://via.placeholder.com/80/0a1428/00bff3?text=Rabadon'
  },
  {
    id: '3',
    ...
    imagem: 'https://via.placeholder.com/80/06101E/C8AA6E?text=Espinhos'
  },
  {
    id: '4',
    ...
    imagem: 'https://via.placeholder.com/80/0a1428/00bff3?text=Trindade'
  },
  ...
  ...Array.from({ length: 15 }).map((_, i) => ({
    ...
    imagem: `https://via.placeholder.com/80/06101E/C8AA6E?text=Item${i+5}`
  }))
];
