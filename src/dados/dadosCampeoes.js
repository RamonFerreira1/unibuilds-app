...
export const dadosCampeoes = [
  {
    ...
    imagem: 'https://via.placeholder.com/150/06101E/C8AA6E?text=Aatrox',
    ...
    skins: [
      { nome: 'Aatrox Clássico', imagem: 'https://via.placeholder.com/200x350/06101E/C8AA6E?text=Classic' },
      { nome: 'Aatrox Justiceiro', imagem: 'https://via.placeholder.com/200x350/0a1428/00bff3?text=Justiceiro' },
    ]
  },
  {
    id: '2',
    ...
    imagem: 'https://via.placeholder.com/150/06101E/C8AA6E?text=Ahri',
    ...
    skins: [
      { nome: 'Ahri Clássica', imagem: 'https://via.placeholder.com/200x350/06101E/C8AA6E?text=Classic' },
      { nome: 'Ahri Fliperama', imagem: 'https://via.placeholder.com/200x350/0a1428/00bff3?text=Fliperama' },
    ]
  },
  ...
  ...Array.from({ length: 10 }).map((_, i) => ({
    ...
    imagem: `https://via.placeholder.com/150/06101E/C8AA6E?text=Champ${i+3}`,
    ...
    skins: [
      { nome: 'Skin Padrão', imagem: 'https://via.placeholder.com/200x350/06101E/C8AA6E?text=Skin1' },
      { nome: 'Skin Alternativa', imagem: 'https://via.placeholder.com/200x350/0a1428/00bff3?text=Skin2' },
    ]
  }))
];
